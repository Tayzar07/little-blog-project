...
<x-admin-layout title="Profile">
    ...
    <div>
        <div class=" p-5 pe-7 w-full bg-white/10 backdrop-blur-sm my-[20px]">
            ...
            <img class="mb-5 border p-2 bg-white/30 rounded-full" width="150px"
                ...
                alt="">
            <form action="/admin/profile/update" class="flex flex-col gap-3" method="post" enctype="multipart/form-data">
                @csrf
                <div>
        ...
        <div class=" p-5 pe-7 w-full bg-white/10 backdrop-blur-sm my-[20px]">
            ...
            <form action="{{ route('password.update') }}" class="flex flex-col gap-3" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div>
